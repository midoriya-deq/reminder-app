...
app.get("/reminders.json", (req, res) => {
    res.sendFile(__dirname + "/public/reminders.json");
});
...
app.post("/addReminder", (req, res) => {
    ...
    fs.readFile("public/reminders.json", "utf8", (err, data) => {
        ...
        fs.writeFile("public/reminders.json", JSON.stringify(reminders, null, 2), (writeErr) => {
...
app.delete("/deleteReminder/:id", (req, res) => {
    ...
    fs.readFile("public/reminders.json", "utf8", (err, data) => {
        ...
        fs.writeFile("public/reminders.json", JSON.stringify(updated, null, 2), (writeErr) => {
